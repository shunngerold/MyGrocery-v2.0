                        ...
                        <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed" style="background-color: rgba(0, 0, 0, 0.763);">
                            <div class="flex justify-center items-center h-full mt-10 md:mt-0">
                                <div class="text-center text-white px-6 md:px-12">
                                    <h1 class="text-3xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">Welcome Customer! <br /><span>Experience the new MyGrocery</span></h1>
                                    <a href="{{ route('user.register') }}" class="inline-block md:px-8 px-5 md:py-4 py-2 mr-1.5 border-2 border-white text-white font-medium md:text-sm text-xs leading-snug uppercase rounded-full shadow-md hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out" data-mdb-ripple="true" data-mdb-ripple-color="light" role="button">Signup Now!</a>
                                </div>
                            </div>
                        </div>
                    </div>
